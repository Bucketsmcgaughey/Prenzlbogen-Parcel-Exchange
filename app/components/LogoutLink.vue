...
<template>
  <div :class="['n-users-logout-container', props.containerClass]" :style="props.containerStyle">
    <div v-if="error" :class="['n-users-error-message', props.errorClass]" :style="props.errorStyle">
      {{ error }}
    </div>
    <v-btn block class="pa-4" color="error" :disabled="isLoading" @click="handleLogout">
